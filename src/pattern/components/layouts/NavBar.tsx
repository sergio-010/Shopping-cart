...
export const NavBar = () => {
    ...
    return (
        <div className='w-full  sticky top-0 left-0 '>
            <div className='items-center justify-between bg-[#F6F6F6] border-b-2 border-black  py-4 md:px-10 md:flex px-7'>
                ...
                <ul className={`md:flex md:items-center md:pb-0 absolute md:static bg-green-500 md:bg-transparent md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9  ${open ? 'top-12' : 'top-[-490px]'}`}>
                    <li className='md:ml-8 md:my-0 my-7 font-semibold'>
                        <NavLink to='/?category=jewelery' className=' hover:text-red-500'>JOYAS</NavLink>
                    </li>
                    <li className='md:ml-8 md:my-0 my-7 font-semibold'>
                        <NavLink to={`/?category=electronics`} className=' hover:text-red-500'>ELECTRONICS</NavLink>
                    </li>
                    <li className='md:ml-8 md:my-0 my-7 font-semibold'>
                        <NavLink to={`/?category=electronics`} className=' hover:text-red-500'>FAVORITOS</NavLink>
                    </li>
                    <li className='md:ml-8 md:my-0 my-7 font-semibold'>
